...
const CookieBanner = () => {
  ...
  return (
    <div
      className={`fixed left-1/2 bottom-[76px] z-50 w-full -translate-x-1/2 flex-col items-center gap-3 rounded-sm border-2 border-gray-300 bg-white p-4 shadow-lg sm:left-6 sm:w-[300px] sm:-translate-x-0 ${
