    ...
    <Section className="h-full bg-secondary-50">
      <Container className="flex h-full flex-col items-start justify-evenly gap-12 lg:flex-row">
        <div className="relative flex w-full flex-col gap-6 lg:w-1/2">
          ...
          <p className="max-w-2xl font-title text-4xl text-primary-900 sm:text-6xl xl:text-8xl">
            {props.caption}
          </p>

          <div className=" relative mt-12 grid h-[600px] w-full grid-cols-12 grid-rows-12 gap-1">
            {props.images.map((image, index) => (
              <div
                key={image.id}
                className={`relative ${contentOneImgGrid[index]}`}
              >
                <Image
                  alt={image.alt}
                  src={image.src}
        ...
        <div className="relative flex h-full w-full flex-col items-start justify-end gap-6 lg:w-1/2">
          ...
          <h3 className="font-heading text-6xl font-bold text-primary-900">
            {props.content_title}
          </h3>
