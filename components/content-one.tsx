        ...
        <div className="relative flex w-full flex-col gap-6 lg:w-1/2">
          ...
          <div className=" group relative mt-12 grid h-[600px] w-full grid-cols-12 grid-rows-12 gap-1">
            {props.images.map((image, index) => (
              <div
                key={image.id}
                className={`relative ${contentOneImgGrid[index]} outline outline-4 outline-offset-8  outline-transparent  duration-300 ease-out hover:z-50 hover:scale-[1.1!important] hover:outline-tertiary-300 rounded-sm`}
              >
                <Image
                  alt={image.alt}
                  src={image.src}
