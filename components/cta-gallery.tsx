    ...
    <Section className="bg-secondary-50">
      <div className="container z-0 mx-auto flex h-full w-full flex-col items-start gap-12 py-2 lg:flex-row">
        <div className="relative z-20 flex w-full flex-col items-start lg:w-1/2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="absolute -top-12 right-0 h-32 w-32 scale-75 fill-current text-gray-300 text-opacity-80 sm:scale-100 lg:top-0"
          >
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="absolute -bottom-20 right-12 h-44 w-44 rotate-12 scale-75 fill-current text-gray-300 text-opacity-80 sm:scale-100 lg:bottom-0"
          >
